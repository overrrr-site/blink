...
const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        question: '登園前入力の活用方法',
        answer: '登園前情報を確認することで、その日のワンちゃんのケアに役立てることができます。例えば、朝ごはんを食べていない場合は体調に注意する、昨夜からウンチが出ていない場合はトイレ誘導を増やすなど、個別対応が可能になります。',
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        question: 'ワンちゃんの登録方法',
        answer: '飼い主詳細画面から「ワンちゃんを追加」ボタンをタップして、ワンちゃんの情報を登録します。',
        steps: [
      ...
      {
        question: '顧客情報の検索',
        answer: '「顧客」タブの検索バーから、飼い主名やワンちゃん名で検索できます。',
      },
      {
        question: '契約情報の管理',
        answer: 'ワンちゃん詳細画面の「契約」セクションから、コース契約の登録・編集ができます。契約期間や料金を設定できます。',
      },
    ],
  },
  {
