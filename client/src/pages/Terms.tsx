      ...
      <main className="px-5 py-8 max-w-3xl mx-auto">
        ...
        <section className="bg-accent/30 rounded-2xl p-6 mb-8">
          ...
          <p className="text-sm leading-relaxed">
            本サービスは、犬の幼稚園運営事業者様（以下「クライアント」）向けに当社が提供するSaaSサービスであり、飼い主様（以下「ユーザー」）はクライアントを通じて本サービスをご利用いただきます。
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
            <p>本サービスは、犬の幼稚園をご利用の飼い主様向けに、以下の機能を提供します。</p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
            ...
            <p>
              犬の幼稚園サービス自体に関する責任は、各クライアント（犬の幼稚園運営事業者）が負うものとし、当社はこれについて責任を負いません。
            </p>
          </div>
        </section>
