      ...
      <main className="px-5 py-8 max-w-3xl mx-auto">
        ...
        <section className="bg-accent/30 rounded-2xl p-6 mb-8">
          <p className="text-sm leading-relaxed mb-4">
            <strong>OVER株式会社</strong>は、LINEミニアプリ「<strong>Blink</strong>」を<strong>{clientName}</strong>に提供しています。
          </p>
          <p className="text-sm leading-relaxed mb-4">
            このサービスを提供するにあたり、<strong>{clientName}</strong>の公式なプライバシーポリシーをOVER株式会社のドメイン内で作成しています。
          </p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
            <p>
              当社およびサービス提供者（{clientName}）は、個人情報の漏洩、滅失、毀損の防止その他の個人情報の安全管理のために必要かつ適切な措置を講じます。
            </p>
            <ul className="list-disc list-inside space-y-1 pl-2">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
            <p>
              ユーザーは、保有する自己の個人情報について、開示・訂正・削除を請求することができます。
              ご請求の際は、<strong>{clientName}</strong>またはOVER株式会社までお問い合わせください。
            </p>
          </div>
        </section>
