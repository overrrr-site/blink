...
function getRouteHandler(router: { stack: Array<{ route?: { path: string; methods?: Record<string, boolean>; stack?: Array<{ handle: (req: Request, res: Response) => Promise<void> }> } }> }, path: string, method: HttpMethod) {
